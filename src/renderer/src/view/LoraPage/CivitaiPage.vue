 ...
 * @LastEditTime: 2025-08-22 18:42:08
      ...
      <nav class="p-3">
        <ul class="space-y-2">
          ...
          <li>
            <button 
              @click="openDevTools"
              class="w-full text-left px-4 py-3 rounded-lg flex items-center transition-all duration-200 hover:bg-gray-100 text-gray-600"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
